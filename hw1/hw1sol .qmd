...
```
**Ans:**There are 431242 rows in the datafile. The number of unique patients is 18073, it did not match the number of patients listed in the `patients.csv.gz` file.
...
![Section 4.1.5 of the book](./rep-res-book.jpg)