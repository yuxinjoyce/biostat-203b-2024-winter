...
```{bash}
zcat < labevents.csv.gz | awk -F, 'BEGIN {OFS=","} NR==1 || ($7==50912 || $2==50971 || $2==50983 || $2==50902 || $2==50882 || $2==51221 || $2==51301 || $2==50931) {print $2, $5, $7, $10}' | gzip > labevents_filtered.csv.gz
```
